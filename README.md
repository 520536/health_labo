...
health_common->health_interface

​	health_interface->health_backend (dubbo zookepper ,jasperPDF ,POI, redis, log4j ,spring-security)

​	health_interface->health_job(redis ,quartz ,log4j )

​	health_interface-> health_mobile (dubbo zookepper,log4j )

​	health_interface->health_service_provider (dubbo zookepper ,mysql,transactionManager, log4j,redis,dao)
...
<project xmlns="http://maven.apache.org/POM/4.0.0"
    ...
    <artifactId>health_labo</artifactId>
    ...
    <!--<module>itextDemo</module>
    <module>jasperReportsDemo</module>-->
</modules>
